...
{
    /// <summary>
    /// QfnTeachingWindow.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class QfnTeachingWindow : Window
    {
        private HObject? teachingImage;

        private QfnTeachingViewModel viewModel;
        ...
        public HObject? TeachingImage
        {
            ...
            set
            {
                if (DataContext is QfnTeachingViewModel viewModel)
                {
        ...
        public QfnTeachingWindow()
        {
            ...
            CurrentTeachingWindow.Instance.InspectionType = EInspection.Qfn;

            viewModel = new QfnTeachingViewModel();
            DataContext = viewModel;
        }

        ~QfnTeachingWindow() => unRegisterEVents();
